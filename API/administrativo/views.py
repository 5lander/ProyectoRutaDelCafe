...
class Emprendimiento_APIView(APIView):
    ...
    def post(self,request,format=None, *args,**kwargs):
        ...
        data ={
            ...
            'nombreEmprendimiento':request.data.get('nombreEmprendimiento'),
            'direccion':request.data.get('direccion'),
            'telCelular':request.data.get('telCelular'),
            'telFijo':request.data.get('telFijo'),
            'descripcion':request.data.get('descripcion'),
            'horaApertura':request.data.get('horaApertura'),
            'horaCierre':request.data.get('horaCierre'),
